...
import GoodCRL from './_inc/crl-good.md';
import CRLEntry from './_inc/crl-revoked-entry.md';
import CRLRevokedArray from './_inc/crl-revoked-as-array.md';
import CRLDupes from './_inc/crl-dupes.md';
import EmptyCRL from './_inc/crl-empty.md';
...
Both `$crl->setThisDate()` and `$crl->setNextDate()` have one required parameter - `$date` - which can be either an instance of `\DateTimeInterface` or a string. If it's a string it'll be passed to the [constructor of `\DateTime`](https://www.php.net/manual/en/datetime.construct.php) and parsed by that.
...
- `$date`
  ...
  Can be an instance of `\DateTimeInterface` or a string or null. If it's a string it'll be passed to the [constructor of `\DateTime`](https://www.php.net/manual/en/datetime.construct.php) and parsed by that.
