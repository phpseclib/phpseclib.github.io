---
title: Supported EC Key Formats
sidebar_position: 7
---
...
Generated by doing `\phpseclib4\Crypt\EC\Formats\Keys\PKCS1::useSpecifiedCurve()` and then `$key->toString('PKCS1')`.
...
Generated by doing `\phpseclib4\Crypt\EC\Formats\Keys\PKCS1::useSpecifiedCurve()` and then `$key->withPassword('demo')->toString('PKCS1')`.
...
Generated by doing `\phpseclib4\Crypt\EC\Formats\Keys\PKCS1::useSpecifiedCurve()` and then `$key->getParameters()->toString('PKCS1')`.
...
Generated by doing `\phpseclib4\Crypt\EC\Formats\Keys\PKCS8::useSpecifiedCurve()` and then `$key->toString('PKCS8')`.
...
Generated by doing `\phpseclib4\Crypt\EC\Formats\Keys\PKCS8::useSpecifiedCurve()` and then `$key->withPassword('demo')->toString('PKCS8')`.
...
Generated by doing `\phpseclib4\Crypt\EC\Formats\Keys\PKCS8::useSpecifiedCurve()` and then `$key->getPublicKey()->toString('PKCS8')`.
...
Generated by doing `\phpseclib4\Crypt\EC\Formats\Keys\XML::enableRFC4050Syntax()` and then `$key->getPublicKey()->toString('XML')`.
