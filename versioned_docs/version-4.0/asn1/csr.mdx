...
CSR is an acronym for [Certificate Signing Request](https://en.wikipedia.org/wiki/Certificate_signing_request). CSR's are mainly used to request X.509 certificates from certificate authorities.
